...
test("save custom message", t => {
    ...
    const template = {
        language: "js",
        script: ' setMessageCustomFieldA("message a");' +
                ' setMessageCustomFieldB("message b");'+
                ' setTransmissionCustomFieldA("transmission a");'+
                ' setTransmissionCustomFieldB("transmission b");'+
                ' module.exports = message.test + "bar";'
    };
    ...
    return javascript.callback(message, template).then(res => {
        t.deepEqual(res, {
            ...
            customFields: {
                ...
                transmissionFieldB: "transmission b",
            },
            console: "",
            messages: []
        });
...
test("queue new messages at gateway", t => {
    t.plan(1);
    ...
    const template = {
        ...
        script: ' setMessageCustomFieldA("message a");' +
                ...
                ' requeueAsMessage({someField: \'with content\', otherField: 123});' +
