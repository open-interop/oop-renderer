    ...
    try {
        ...
        const bootstrap = await isolate.compileScript(
            `
                ...
                module = { exports: null, discard: false, customFields: {}, messages: [] };
                ...
                setMessageCustomFieldA = (val) => {
                    module.customFields.messageFieldA = val;
                };

                setMessageCustomFieldB = (val) => {
                    module.customFields.messageFieldB = val;
                };

                setTransmissionCustomFieldA = (val) => {
                    module.customFields.transmissionFieldA = val;
                };

                setTransmissionCustomFieldB = (val) => {
                    module.customFields.transmissionFieldB = val;
                };

                requeueAsMessage = (body) => {
                    module.messages.push(body);
                };
            `
        );
        ...
        return {
            ...
            console: log,
            customFields: module.customFields,
